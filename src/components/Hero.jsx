...
function Hero() {
  return (
    <section
      ...
      style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.55), rgba(0,0,0,0.55)), url(${heroImage})` }}
    >
      <div className="max-w-7xl mx-auto px-6 text-white text-center md:text-left">
        
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold max-w-3xl leading-tight mx-auto md:mx-0">
        ...
        <p className="mt-6 text-base md:text-lg max-w-2xl text-gray-200 mx-auto md:mx-0">
          Safe, reliable and affordable tree services for your home or business.
          We care for your trees like our own.
        </p>
